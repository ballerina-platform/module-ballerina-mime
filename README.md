...
===================
  ...
  [![GraalVM Check](https://img.shields.io/github/workflow/status/ballerina-platform/module-ballerina-mime/Build%20with%20bal%20test%20native?label=GraalVM%20Check)](https://github.com/ballerina-platform/module-ballerina-mime/actions/workflows/build-with-bal-test-native.yml)
